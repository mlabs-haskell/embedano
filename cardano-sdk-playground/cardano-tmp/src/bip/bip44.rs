...
//!
//! ```
//! # extern crate cardano-tmp;
//! use cardano-tmp::bip::bip44::{Account, Change, Addressing};
//!
...
/// the BIP44 coin type is set, by default, to cardano-tmp ada.
...
impl Addressing {
    ...
    ///
    /// ```
    /// use cardano-tmp::bip::bip44::{Addressing, AddrType};
    ///
    ...
    ///
    /// ```
    /// use cardano-tmp::bip::bip44::{Addressing, AddrType, Index};
    ///
    /// let addr = Addressing::new(0, AddrType::External, 0).unwrap();
    ///

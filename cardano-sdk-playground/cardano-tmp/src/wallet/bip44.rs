...
impl Account<XPrv> {
    ...
    ///
    /// ```
    /// # use cardano-tmp::wallet::{bip44::{self, AddrType}, scheme::{Wallet}};
    /// # use cardano-tmp::bip::bip39::{MnemonicString, dictionary::ENGLISH};
    /// # use cardano-tmp::address::ExtendedAddr;
    /// # use cardano-tmp::util::base58;
    /// # use cardano-tmp::config::{NetworkMagic};
    ///
